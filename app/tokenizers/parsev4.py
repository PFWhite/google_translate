...
def main(args=docopt(__doc__)):
    ...
    # change this to size of vocab size manually
    ...
    for index, line in enumerate(infile):
        ...
        # I changed this to be a large arbitrary number to eliminate issues with the indices being out of bounds
        goodtokens = ["" for x in range(100)]
